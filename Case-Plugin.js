...
💐💐💐💐💐💐
    ...
    try {
        ...
        const buttonMessage = {
            ...
            footer: config.FOOTER || '🧚‍♂️𝐂ʏʙᴇʀ-𝐅ʀᴇᴇᴅᴏᴍ-𝐌ɪɴɪ-𝐁ᴏᴛ🧚‍♂️',
            buttons: buttons,
            headerType: 4
        };
    ...
    try {
        ...
        const cards = await Promise.all(selected.map(async (vid) => {
            ...
            return {
                ...
                footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: "CYBER-FREEDOM" }),
            ...
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                        ...
                        footer: { text: "> CYBER FREEDOM MINI BOT" },
    ...
    💐💐💐💐
          ...
          case "owner":
        {
          ...
          const vcard =
            ...
            "FN:Sandaru \n" +
            "ORG:Owner;\n" +
            "TEL;type=CELL;type=VOICE;waid=94763441376:+94789227570\n" +
            "END:VCARD";
